...
<?php
	...
	echo '<button type="submit" onclick="memeCategorySubscribeFunction(0,\'Just My Thoughts\',\''.$memeCategorySubscribersLabel.'\');" name="subscribecategoryJust My Thoughts" class="btn" id="userprofile-subscribe-button" style="margin-top:50px;margin-left:10px">'.$subscribeToMemeCategoryInnerHtml.'</button>';
	echo '</div>';
?>
</div>
