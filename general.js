...
$(document).ready(function(){
    ...
    //alert(width);
    if(width<1048 && window.location.pathname!='/mobile_tablet_landing_page.php'){
...
$(document).ready(function(){
    $('body').on('click','.notifications-button',function(e){
        ...
        if(window.location.pathname=='/userprofile.php'){    
            ...
            if($("#notifications-tab").length)
            {
                ...
                if(document.getElementById("notifications-tab").style.display=="none")
                {
                    ...
                    //$("html, body").animate({ scrollTop: $("#cp").offset().top }, 2000);
            ...
            {
                //window.location.href="userprofile.php?id="+sessionId+"#notifications-tab";
            }
                ...
                ({
                    ...
                    success: function (response) 
                    {
                        ...
                        if(response.trim()=="not logged in"){
                            ...
                            $(divname).children(".edit-panel").show();
                            //alert(divname);
            ...
            ({
                ...
                success: function (response) 
                {
                    if(response.trim()=="not logged in"){
                        ...
                        $(divname2).children(".edit-panel").show();
                        //alert(divname2);
                        //increasing the number of replies for the comment
                        document.getElementById("numberOfReplies"+commentId).innerHTML="Replies: "+(numberOfReplies+1);//herer we increase the number of replies by 1 and then update the innerHTML of the <p> which displays the number of replies to this particular comment
                    }   
                },
                error: function(xhr, status, error) {
                    alert(xhr.responseText);
...
$(document).ready(function(){
    if(window.location.hash){
        ...
        if(stringtobechecked=="commentdiv"){
            ...
            var y=$(window.location.hash).parent().parent().position().top;//gets position of the comment from the top
            //alert("window.location.hash="+window.location.hash+"y="+y);
            $(window).scrollTop(y-40);
            
            $(window.location.hash).css('backgroundColor','hsl(215, 9%, 73%)');
            ...
            for(var i=50; i<=100; i=i+1){ //i represents the lightness
                ...
                (function(ii,dd){
                    setTimeout(function(){
                        $(window.location.hash).css('backgroundColor','hsl(215,9%,'+ii+'%)'); 
                    }, dd);    
                })(i,d);
            }
        }
        else if(stringtobechecked=="answerdiv"){
            //if the stringtobechecked equals "commentdiv" then the redirection is done due to the pressing of the "showreplyformbutton" so, we'll now toggle the showreplyform div
            //var divname="#replyform"+id;//here, we get the name of the div which is being toggled..this is done by getting the value inside the "name" attribute of the show all replies button..this attribute for every button is the comment id for which the reply has been posted...we add the comment id at the end of "allreplies" and this makes the class name of the div containing all the replies for that particular comment
            //alert(divname);
            //$(divname).toggle();
        ...
        }else if(stringtobechecked=="answerreplydiv"){
            //if the stringtobechecked equals "commentdiv" then the redirection is done due to the pressing of the "showreplyformbutton" so, we'll now toggle the showreplyform div
            //var divname="#replyform"+id;//here, we get the name of the div which is being toggled..this is done by getting the value inside the "name" attribute of the show all replies button..this attribute for every button is the comment id for which the reply has been posted...we add the comment id at the end of "allreplies" and this makes the class name of the div containing all the replies for that particular comment
            //alert(divname);
            //$(divname).toggle();
            //alert("iyhgfd");
            $("#answerreply_div"+id).parent().show();
            var y=$(window.location.hash).parent().parent().parent().parent().position().top;//gets position of the comment from the top
            //alert("window.location.hash="+window.location.hash+"y="+y);
            //alert(y);
            $(window).scrollTop(y-40);
        ...
        else if(stringtobechecked=="replydiv"){
            //if the stringtobechecked equals "commentdiv" then the redirection is done due to the pressing of the "showreplyformbutton" so, we'll now toggle the showreplyform div
            //var divname="#replyform"+id;//here, we get the name of the div which is being toggled..this is done by getting the value inside the "name" attribute of the show all replies button..this attribute for every button is the comment id for which the reply has been posted...we add the comment id at the end of "allreplies" and this makes the class name of the div containing all the replies for that particular comment
            //alert(divname);
            $("#reply_div"+id).parent().show();
            ...
            $('body').animate({scrollTop: $(window.location.hash).offset().top}, 1500);//answer to a question ka scroll from memedevelopers forum to question display.php OR comment on a meme ka scroll in image display.php
        }
    }
});
            ...
            ({
                ...
                {                    
                    ...
                    {        
                        ...
                        document.getElementById("numberOfReplies"+commentId).innerHTML="Replies: "+(numberOfReplies-1);//reduces number of replies by one on webpage for this comment
...
$(document).ready(function(){
    ...
    $("#uploadmemeform"+sessionId).submit(function(e){ 
        e.preventDefault();
        document.getElementById("uploadmemeerror").innerHTML="Uploading...";
        var formData = new FormData(this);
            $.ajax
            ({
                type: 'POST',
            ...
            ({
                ...
                success: function (response) 
                {
                    ...
                    if(response.trim()==="no file selected"){
                        ...
                        document.getElementById('updateProfilePictureError').innerHTML="Updated!";
            ...
            ({
                ...
                success: function (response) 
                {
                    ...
                    if(response.trim()=="wrong file type"){
                        ...
                        document.getElementById(numberOfAnswersname).innerHTML=(numberOfAnswersActual+1)+" answers";
                        var divname="#"+$(".answer_div").first().attr('id');//gets the id of the comment div that has just been added
                        //$("html, body").animate({ scrollTop: $(divname).offset().top }, 1000);//scrolls down to the comment
                        $(divname).children(".edit-panel").show();//displays the edit panel
                    }
                }
            });
        //} 
            ...
            ({
                ...
                success: function (response) 
                {
                    ...
                    if(response.trim()=="wrong file type"){
                        ...
                        var divname2="#"+$(divname).children().last().attr('id');//gets the id of the last reply in order to scroll to it
                        $(divname2).children(".edit-panel").show();//displays the edit panel
                        //alert(divname2);
                        //$("html, body").animate({ scrollTop: $(divname2).offset().top }, 1000);//scrolls down to the comment
                    }
                }
        ...
        {   
            ...
            ({
                ...
                {                    
                    ...
                    if(response=="success")     
                    {        
                        $(self).parent().parent().remove();//removes the entire div that contains this comment.. the .parent() function is used since even the delete button lies in this div hence, the div becomes the button's parent
                        document.getElementById(numberOfAnswersname).innerHTML=(numberOfAnswers-1)+" answers"; 
                    }  
                },
                error: function(xhr, status, error) {
                    alert(xhr.responseText);
...
$(document).ready(function(){
    ...
    $(".acceptfriendrequestform").submit(function(e){ 
        ...
        if(confirm("Do you really wish to accept the friend request from this user?")){
            ...
            var getnumber=($(document.activeElement).attr('id')).match(/\d+$/);//gets the number at the end of the string and then stores it in the zeroth position of an array
            if(getnumber){
                var id = parseInt(getnumber[0]);//converts the number which is stored in the form of string to an integer
            }
            var btn="bottom";
            if($("#acceptfriendrequestform"+id).attr('name')=="userprof_top_friend_req_btn")
            {
                btn="up_top";//means the top accept friend request button has been pressed
            }
            //alert($("#acceptfriendrequestform"+id).attr('name'));
            //alert(btn);
            ...
            ({
                ...
                success: function (response) 
                {
                    ...
                    {
                        $("#acceptfriendrequestform"+id).hide();
                        $("#friends").show();
                    }
            ...
            ({
                ...
                {               
                    ...
                    else if(response=="hacken")
                    {
                        ...
                        document.getElementsByClassName("groupNumberOfParticipants")[0].innerHTML="Participants: "+(numberOfParticipants-1);
...
$(document).ready(function(){
    ...
    tabs.find('a').on('click', function(e){
        ...
        //alert(y);
        if(!($(this).attr('id')=="memes-tab"||$(this).attr('id')=="subscriptions-tab"||$(this).attr('id')=="social-tab"||$(this).attr('id')=="notif-tab")){
             window.scrollTo(0,0);
        }else{
            window.scrollTo(0,y);
        }
            ...
            ({
                ...
                {   //alert(response);          
                    if(response=="success"){
                        ...
                        document.getElementById("inviteToMeaglMessage").innerHTML="Please enter the email first.";
                    }
    ...
    $('body').on('submit', '.signupForm', function(e){ 
        ...
        ({
            ...
            {   
                ...
                else if(response=="username too long")
                {
                     document.getElementById("signInError").innerHTML="Your username is longer than 15 characters.";
                }
                else{
                    //alert("hey bi");
    ...
    $('body').on('submit', '.loginForm', function(e){ 
        ...
        ({
            ...
            {   
                ...
                {
                    document.getElementById("logInError").innerHTML="Your email or password is incorrect!";
...
$(document).ready(function(){
    ...
    $(document).on('click','.display-edit',function(){
        //if(window.)
        $(this).parent().next().toggle();
    });
    ...
    $('#notifications').click(function(){
        $('.notif').removeClass('addBackground');
        $('.small-notifications-column').slideToggle();
    });
    if(title=="MEAGL")
    {
        ...
        ctx.beginPath();
            ctx.rect(0,2,$('#recommendedmemes').width()+13.5,canvas.height);
    ...
    $('#recommendedmemes').click(function(){
        ...
        $(".sign-out-recom").addClass('sign-out-class');
        $(this).css({'color':'#666'});
        $('.sign-out-trend').removeClass('sign-out-class');
        $('.sign-out-recom').removeClass('border');
    ...
    $('#trendingmemes').click(function(){
        ...
        ctx.clearRect(0,0,canvas.width,canvas.height);
        ctx.beginPath();
        ctx.rect($('#recommendedmemes').width()+64,2,$(this).width()+40,canvas.height);
        //ctx.rect($('#recommendedmemes').width()+61.5,0,3,canvas.height);
        ctx.rect(0,0,$('#recommendedmemes').width()+64,canvas.height);
        ...
        //ctx.rect($('#recommendedmemes').width()+$(this).width()+84.5,0,3,canvas.height);
        ctx.fillStyle="#b522a8";
        ctx.fill();
        ...
        $(".sign-out-recom").removeClass('sign-out-class');
        $(this).css({'color':'#666'});
        $('.sign-out-trend').addClass('sign-out-class');
        $('.sign-out-fresh').removeClass('sign-out-class');
        $('.sign-out-fresh').css({'color':'#aaa'});
        $('.sign-out-recom').css({'color':'#aaa'});
    });
    ...
    $('#freshmemes').click(function(){
        ...
        ctx.clearRect(0,0,canvas.width,canvas.height);
        ctx.beginPath();
        ctx.rect($('#recommendedmemes').width()+$('#trendingmemes').width()+134,2,$(this).width()+40,canvas.height);
        //ctx.rect($('#recommendedmemes').width()+$('#trendingmemes').width()+132,0,3,canvas.height);
        ctx.rect(0,0,$('#recommendedmemes').width()+$('#trendingmemes').width()+134,canvas.height);
        //ctx.rect($('#recommendedmemes').width()+$('#trendingmemes').width()+43,0,3,canvas.height);
        ctx.rect($('#recommendedmemes').width()+$('#trendingmemes').width()+$(this).width()+154.5,0,canvas.width,canvas.height);
        //ctx.rect($('#recommendedmemes').width()+$('#trendingmemes').width()+$(this).width()+154,0,3,canvas.height);
        ctx.fillStyle="#b522a8";
        ctx.fill();
        $('.recommendedmemes').hide();
        $('.trendingmemes').hide();
    ...
    $('#shuffle').click(function(){
        ...
        ctx.clearRect(0,0,canvas.width,canvas.height);
        ctx.beginPath();
        ctx.rect(0,0,canvas.width-$(this).width()-30,canvas.height);
        ctx.rect(canvas.width-$(this).width()-30,2,$(this).width()+23,canvas.height);
        //ctx.rect(canvas.width-$(this).width()-34,0,3,canvas.height);
        ctx.rect(canvas.width-10,0,3,canvas.height);
        ctx.rect
        ctx.fillStyle="#b522a8";
        ctx.fill();
        $('.recommendedmemes').hide();
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(title=="Upload Meme"){
        $('.rule').hover(function(){
            $(this).css({
                "cursor":"default",
                "color":"#ef22ef",
            });
            $(this).children('.full-rule').slideToggle();
