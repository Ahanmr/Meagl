...
if(isset($_SESSION['id'])){
	...
	<div class="tabs">
		...
		<a id="trendingmemes" href="#trending">Trending</a>
		<a id="freshmemes" href="#fresh">Fresh</a>	
		<a id="shuffle" href="#shuffled">Shuffle</a>	
		<canvas id="tab-bottom" width="600" height="3"></canvas>
<?php
}else{
	?>
	<div class="tabs">
		<a id="trendingmemes" class="sign-out-trend" href="#trending" style="color: #aaa;border-radius:3px;top:3.5px;left:65px">Trending</a>
		<a id="freshmemes" class="sign-out-fresh" href="#fresh" style="color: #aaa;border-radius:3px;top:3.5px;left:50px">Fresh</a>	
